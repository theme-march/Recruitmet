...
export async function GET() {
  try {
    ...
    // Live counts for all 3 country pipelines and call center
    const [ksaFiles, dubaiFiles, otherFiles, workCalls, interviews, demands] = await Promise.all([
