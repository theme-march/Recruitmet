...
export function AllCandidatesListPage() {
    ...
    <div style={{ maxWidth: "1600px", margin: "0 auto", paddingBottom: "40px" }}>
      ...
      {selectedCandidate && (
        ...
        >
          ...
          >
            {/* Modal Header */}
            <div style={{ padding: "20px 24px", borderBottom: "1px solid var(--line)", background: "#fafafd", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
              <div>
