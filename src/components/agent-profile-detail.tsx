...
export function AgentProfileDetail() {
  ...
  const [activeMainTab, setActiveMainTab] = useState<"ledger" | "interviews" | "docs">("ledger");
  ...
  const getCleanCountryName = (country: string) => {
  ...
  return (
    <div style={{ maxWidth: "1600px", margin: "0 auto", display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      {/* 3.5. SCREENING & INTERVIEWS PIPELINE STRIP (Theme Adjusted) */}
      <div
        style={{
          background: "#ffffff",
          borderRadius: "18px",
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: "12px" }}>
          ...
          <div style={{ background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: "12px", padding: "14px 16px" }}>
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: "4px", marginTop: "4px" }}>
              <b style={{ fontSize: "20px", fontWeight: 900, color: "var(--ink)" }}>{totalRegistered}</b>
              <span style={{ fontSize: "12px", color: "var(--muted)", fontWeight: 700 }}>Candidates</span>
            </div>
          ...
          <div style={{ background: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: "12px", padding: "14px 16px" }}>
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: "4px", marginTop: "4px" }}>
              <b style={{ fontSize: "20px", fontWeight: 900, color: "#15803d" }}>{selectedCount}</b>
          ...
          <div style={{ background: "#fffbeb", border: "1px solid #fde68a", borderRadius: "12px", padding: "14px 16px" }}>
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: "4px", marginTop: "4px" }}>
              <b style={{ fontSize: "20px", fontWeight: 900, color: "#b45309" }}>{waitingCount}</b>
          ...
          <div style={{ background: "#eff6ff", border: "1px solid #bfdbfe", borderRadius: "12px", padding: "14px 16px" }}>
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: "4px", marginTop: "4px" }}>
              <b style={{ fontSize: "20px", fontWeight: 900, color: "#1d4ed8" }}>{attendedCount}</b>
          ...
          <div style={{ background: "#fff1f2", border: "1px solid #fecdd3", borderRadius: "12px", padding: "14px 16px" }}>
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: "4px", marginTop: "4px" }}>
              <b style={{ fontSize: "20px", fontWeight: 900, color: "#e11d48" }}>{rejectedCount}</b>
          ...
          <div style={{ background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: "12px", padding: "14px 16px" }}>
            ...
            <div style={{ display: "flex", alignItems: "baseline", gap: "4px", marginTop: "4px" }}>
              <b style={{ fontSize: "20px", fontWeight: 900, color: "#475569" }}>{absentCount}</b>
          ...
          <div style={{ display: "flex", gap: "8px" }}>
            <button
              ...
              style={{
                ...
                borderRadius: "10px",
                border: "2px solid",
                borderColor: activeMainTab === "ledger" ? "#7258e8" : "transparent",
                background: activeMainTab === "ledger" ? "#f0edff" : "#f8fafc",
                color: activeMainTab === "ledger" ? "#7258e8" : "var(--muted)",
                fontSize: "12.5px",
                fontWeight: 800,
                cursor: "pointer",
              }}
            >
              <Layers size={15} /> Candidate Processing &amp; Financial Ledger ({agentData.candidates.length})
            </button>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "10px",
                border: "2px solid",
                borderColor: activeMainTab === "interviews" ? "#7258e8" : "transparent",
                background: activeMainTab === "interviews" ? "#f0edff" : "#f8fafc",
                color: activeMainTab === "interviews" ? "#7258e8" : "var(--muted)",
                fontSize: "12.5px",
                fontWeight: 800,
                cursor: "pointer",
              }}
            >
              <CalendarDays size={15} /> Interview Drives ({allInterviews.length})
            </button>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "10px",
                border: "2px solid",
                borderColor: activeMainTab === "docs" ? "#7258e8" : "transparent",
                background: activeMainTab === "docs" ? "#f0edff" : "#f8fafc",
                color: activeMainTab === "docs" ? "#7258e8" : "var(--muted)",
                fontSize: "12.5px",
                fontWeight: 800,
                cursor: "pointer",
              }}
            >
              <FileCheck2 size={15} /> Documents &amp; Notes ({agentData.documents.length + agentData.agentNotes.length})
            </button>
          </div>
        </div>
      ...
      {showEditModal && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(15,23,42,0.6)", backdropFilter: "blur(4px)", display: "grid", placeItems: "center", zIndex: 9999, padding: "20px" }}>
          <div style={{ background: "#fff", borderRadius: "16px", maxWidth: "520px", width: "100%", padding: "24px", boxShadow: "0 20px 40px rgba(0,0,0,0.2)" }}>
