...
export function InterviewListPage({ upcomingOnly = false, initialData }: { upcomingOnly?: boolean; initialData?: { data: Schedule[] } } = {}) {
  ...
  const query = useQuery<Schedule[]>({
    ...
    initialData: !search ? initialData?.data : undefined,
    queryFn: async () => {
